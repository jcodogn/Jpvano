      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-8 border-b border-black/5 pb-8">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <span className="bg-emerald-500 text-white text-[10px] px-2 py-1 rounded font-black uppercase tracking-widest">Netlify Live</span>
          </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2 bg-white/5 px-3 py-1.5 rounded-full border border-white/10">
                    ...
                    <span className="text-[8px] font-black uppercase tracking-widest">Netlify Deploy: OK</span>
                  </div>
